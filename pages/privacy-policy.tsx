...
const PrivacyPolicy: React.FC = () => {
    return (
        <div className="bg-slate-900 text-slate-50 flex flex-col">
                    ...
                    <div className="pb-6">
                        ...
                        <div className="text-left px-20">
                            ...
                            <p className="pb-3">
                                ...
                                (forkcommitmerge.io). This Privacy Policy
                                governs your use of our website. This SERVICE is
                                provided by Fork, Commit, Merge at no cost and
                            ...
                            <p className="pb-1">
                                We collect the following data if you choose to
                                login with your Github credentials to our
                                platform:
                            </p>
                            <ul>
                            ...
                            <ul className="pb-2">
                                ...
                                <li className="pl-4">
                                    - Search for the number of issues you have
                                    made in our repository by looking at all the
                            ...
                            <p className="pb-3">
                                ...
                                database. We use the OAuth2 protocol to
                                authenticate you with Github.
                            </p>

                            <h2 className="pb-2 text-2xl">5. Data Sharing</h2>
                            <p className="pb-3">
                                We do not share your data with third parties. We
                                do not sell your data to third parties. We do
                            ...
                            <p className="pb-3">
                                ...
                                for any changes. We will notify you of any
