...
export const ides: IDEInfo[] = [
  ...
  },
  {
    ...
    supportedLanguages: ['Almost all through extensions and language servers'],
    installLink: 'https://neovim.io/'
  },
  ...
  },
  {
    ...
    supportedLanguages: ['JavaScript', 'TypeScript', 'HTML', 'CSS', 'Node.js'],
  ...
  {
    name: 'CLion',
    description: 'A cross-platform IDE for C and C++ developed by JetBrains.',
    functionalities: [
      'Smart code analysis',
      'Code generation',
      'Refactoring',
  ...
  },
  {
    ...
    supportedLanguages: ['HTML', 'CSS', 'JavaScript', 'Ruby', 'Python', 'PHP'],
  ...
  {
    name: 'BlueJ',
    description: 'A free Java development environment designed for beginners.',
    functionalities: [
      'Simple interface',
