            ...
            <div className="w-full md:w-1/2 mb-8">
                <div className="max-w-md mx-auto">
                    ...
                    <p className="mb-4 max-w-prose">
                        ...
                        distribute. Contributing to open source projects is a
                        great way to improve your coding skills, work on
                        real-world projects, and potentially make a meaningful
                        impact in the software that people use every day.
                    </p>
