    ...
    return (
        <div className="flex justify-center items-center bg-slate-900">
            <div className="text-center text-slate-50 max-w-2xl">
                <h1 className="text-3xl font-bold mb-10">Fortran</h1>

                <h2 className="text-2xl font-bold mb-4">What is Fortran?</h2>
                <p className="mb-4">
                    Fortran, short for Formula Translation, is a high-level,
                    general-purpose programming language that was developed in
                    the 1950s for scientific and engineering applications. It is
                    one of the oldest programming languages and is particularly
                    strong in numerical and computational tasks.
                </p>

                <h2 className="text-2xl font-bold mb-4">Why Use Fortran?</h2>
                <p className="mb-6">
                    Fortran remains a language of choice for high-performance
                    computing and is commonly used in scientific research. Its
                    syntax is designed to be simple and straightforward, and
                    modern Fortran standards have added support for
                    object-oriented, modular, and generic programming.
                </p>
