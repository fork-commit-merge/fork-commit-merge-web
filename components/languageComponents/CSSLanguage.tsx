    ...
    return (
        <div className="flex justify-center items-center bg-slate-950">
            <div className="text-center text-slate-50 max-w-2xl">
                <h1 className="text-3xl font-bold mb-10">CSS</h1>
                ...
                <p className="mb-4">
                    ...
                    in HTML. CSS describes how elements should be rendered on
                ...
                <p className="mb-6">
                    ...
                    including layout, colors, and fonts. This makes it easier to
                    maintain websites, share styles across multiple pages, and
                    tailor pages to different environments. It&apos;s also
                    essential for responsive design and enhancing the user
                    experience.
                </p>
                ...
                <ul>
                    ...
                    <li>
                        - Prefer using relative units like `em` and `rem` over
