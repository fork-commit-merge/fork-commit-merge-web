    ...
    return (
        <div className="flex justify-center items-center bg-slate-950">
            <div className="text-center text-slate-50 max-w-2xl">
                <h1 className="text-3xl font-bold mb-10">Java</h1>

                <h2 className="text-2xl font-bold mb-4">What is Java?</h2>
                <p className="mb-4">
                    Java is a high-level, object-oriented programming language
                    that was initially released by Sun Microsystems in 1995. It
                    is platform-independent, meaning that code written in Java
                    can run on any device that has a Java Virtual Machine (JVM).
                    Java is widely used for building enterprise-scale web
                    applications and Android mobile app development.
                </p>
                ...
                <ul>
                    ...
                    <li>
                        - Use meaningful variable and method names that follow
                        the camelCase naming convention.
                    </li>
                    <li>
                        - Favor composition over inheritance to make your code
                        more modular.
                    </li>
                    <li>
                        - Always make use of access modifiers to encapsulate
                        your code effectively.
                    </li>
                    <li>
                        - Use exceptions for error handling, but don’t overuse
                        them.
                    </li>
                </ul>
                <br />
