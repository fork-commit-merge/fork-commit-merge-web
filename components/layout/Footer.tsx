                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                        ...
                        <div className="text-center w-full">
                            ...
                            <p className="text-base text-slate-50">
                                <Link
                                    className="py-2 px-3 mt-2 border border-transparent text-sm font-medium rounded-md text-white bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 inline-flex items-center space-x-2"
                                    href={
