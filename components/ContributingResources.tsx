            ...
            <div className="w-full md:w-1/2 mb-20">
                <div className="max-w-md mx-auto">
                    ...
                    <p className="mb-4 max-w-prose">
                        Here you&apos;ll find a collection of video tutorials on
                        a wide range of topics related to open-source
                        contributions. From comprehensive guides to first-time
                        experiences, these resources will help you understand
                        and navigate the world of open source.
                    </p>
                    <ul className="list-disc pl-5">
                        ...
                        <li>
                            <a
                                ...
                                className="hover:underline text-blue-400"
                            >
                                How to Contribute to Open Source Projects? (Tiff
                                In Tech)
                            </a>
                        </li>
                        <li>
