  ...
  return (
    <>
      <div className="px-4">
        ...
        <p className="text-lg leading-7">
          Python is a high-level, interpreted language known for its ease of use
          and simplicity. With Python issues in the repository, contributors can
          develop a solid understanding of Python, and improve their skills in
        ...
        <p className="text-lg leading-7">
          ...
          simplicity. Ruby issues in this repository will help contributors
          understand the syntax, features, and powerful frameworks like Ruby on
          Rails.
        </p>
        <hr className="my-6" />
        <h3 className="text-2xl font-semibold my-3 mt-10">
        ...
        <p className="text-lg leading-7">
          ...
          Through the Tailwind CSS issues in this repository, contributors can
          practice and understand the utility-first principle in designing web
          applications.
        </p>
        <hr className="my-6" />
        <h3 className="text-2xl font-semibold my-3 mt-10">
        ...
        <p className="text-lg leading-7">
          ...
          evaluation of mathematical functions. Through issues related to
          Haskell, Lua, Clojure, and Lisp in this repository, contributors can
          delve into the world of functional programming, immutability, and
          declarative code writing.
        </p>
        <hr className="my-6" />
        ...
        <p className="text-lg leading-7">
          Fortran and Erlang are languages with rich histories and unique
          applications. Fortran is extensively used in scientific and numerical
          computations, while Erlang is known for its concurrent programming
          capabilities. Contributors can explore these languages and their
      ...
      <div className="mb-8 px-4">
        ...
        <p className="text-lg leading-7">
          TypeScript, a statically-typed superset of JavaScript, is quickly
          gaining popularity in the development community. This repository
          includes TypeScript issues that allow contributors to understand and
          appreciate the importance of types in programming, thus enhancing
          their TypeScript skills.
        </p>
        <hr className="my-6" />
        <h3 className="text-2xl font-semibold my-3 mt-10">
        ...
        <p className="text-lg leading-7">
          Debugging is an art, and mastering it can save a lot of time and
          effort. This repository encourages contributors to find and fix bugs
          in the codebase, thus polishing their debugging skills.
        </p>
        <hr className="my-6" />
        <h3 className="text-2xl font-semibold my-3 mt-10">
        ...
        <p className="text-lg leading-7">
          SQL is a standard language for managing data held in relational
          databases. SQL issues within the repository offer contributors an
          opportunity to work with databases, write queries, and understand how
        ...
        <p className="text-lg leading-7">
          ...
          to parse and generate. JSON issues in this repository allow
          contributors to understand how JSON works, how to generate JSON
          objects, and how to parse them.
        </p>
        <hr className="my-6" />
        <h3 className="text-2xl font-semibold my-3 mt-10">Work with YAML</h3>
        <p className="text-lg leading-7">
          ...
          this repository allow contributors to understand how to write YAML
          files and use them for configuration and data sharing between
          languages with different data structures.
        </p>
        <hr className="my-6" />
        <h3 className="text-2xl font-semibold my-3 mt-10">Explore C and C++</h3>
        <p className="text-lg leading-7">
          C and C++ are foundational programming languages that provide a deep
          understanding of computer systems. Through the C and C++ issues in
          this repository, contributors can understand the core concepts of
          programming, memory management, and low-level access to computer
          memory.
        </p>
        <hr className="my-6" />
        ...
        <p className="text-lg leading-7">
          This repository hosts challenges in modern languages like Kotlin,
          Scala, Elixir, and Dart. These languages provide powerful features and
          are widely used in industry applications. Contributors can get a grasp
          of functional programming and other advanced programming paradigms.
        </p>
        <hr className="my-6" />
        ...
        <p className="text-lg leading-7">
          Rust and Go are modern systems programming languages known for their
          performance and reliability. The Rust and Go issues in this repository
          allow contributors to understand memory safety, concurrency, and the
          principles of modern systems development.
        </p>
        ...
        <p className="text-lg leading-7">
          Dive into the world of blockchain development with Solidity and Vyper.
          Learn to build smart contracts and DApps on diverse blockchain
